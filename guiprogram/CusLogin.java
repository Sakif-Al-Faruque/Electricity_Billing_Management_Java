...
public class CusLogin extends JFrame implements ActionListener 
{
	...
	public CusLogin()
	{
		...
		l1 = new JLabel("                CUSTOMER  SIGN IN ");
	...
	public void actionPerformed(ActionEvent ae)
		{
			...
			else if(ae.getSource()==b2)
			{
				...
				Login l = new Login(Username, Password, "customer");
                if(l.checkUser()){
                    //forward customer dashboard page
					CusDashboard k = new CusDashboard(l.getUserId());
					//k.setId();
                    this.setVisible(false);
                    k.setVisible(true);
                }else{
                    ...
                    LoginError h = new LoginError("Customer");
                    this.setVisible(false);
                    h.setVisible(true);
                }
