...
public class FileOperation{
    ...
    public FileOperation(String fileName){
        ...
        try{
            f = new File("guiprogram/datafile/"+fileName);
            f.createNewFile();
        }catch(IOException e){
    ...
    public void setData(String[] columns, boolean append){
        try{
            FileWriter fw = new FileWriter("guiprogram/datafile/"+this.fileName, append);
            String infoRow = "";
    ...
    public void setTotalData(String[] rows){
        try{
            FileWriter fw = new FileWriter("guiprogram/datafile/"+this.fileName);
            String infoRow = "";
