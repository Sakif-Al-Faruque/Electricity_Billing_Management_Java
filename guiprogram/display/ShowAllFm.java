...
public class ShowAllFm extends JFrame implements ActionListener
{
		JButton b1, b2, b3; 
		JPanel p1,p2,p3;
        JTable tab;
	...
	public ShowAllFm()
	{
		...
		l1 = new JLabel("                       FIELD  MANAGER  LIST        ");
        ...
        String[] cusInfoFieldData  =  new String[6];
    ...
    public void actionPerformed(ActionEvent ae)
		{
			...
			{
				String FIELD_MANEGER_ID = t1.getText();

                UpdateFm uf = new UpdateFm(FIELD_MANEGER_ID);
				uf.setAdminId(ADMIN_ID);
                this.setVisible(false);
                uf.setVisible(true);
			...
			else if(ae.getSource()==b3)
			{
                ...
                DeleteFm df = new DeleteFm(FIELD_MANEGER_ID);
                //df.setId(FIELD_MANEGER_ID);
				df.setAdminId(ADMIN_ID);
                this.setVisible(false);
                df.setVisible(true);
			}
		}
