...
public class FmLogin extends JFrame implements ActionListener 
{
	...
	public FmLogin()
	{
		...
		l1 = new JLabel("              FIELD  MANEGER  SIGN IN ");
	...
	public void actionPerformed(ActionEvent ae)
		{
			...
			else if(ae.getSource()==b2)
			{
				...
				Login l = new Login(Username, Password, "field-maneger");
                if(l.checkUser()){
                    //forward field maneger dashboard page
					String id = l.getUserId();
					FmDashboard e = new FmDashboard(id);
					//e.setId(id);
                    this.setVisible(false);
                    e.setVisible(true);
                }else{
